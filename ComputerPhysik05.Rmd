...
Wir wollen dieses Verhalten im Folgenden numerisch untersuchen. Hierzu schreiben wir Gleichung \ref{gl1} mit $\Xi = \frac{x}{l}, \phi = \frac{\psi}{l}, \tau = \frac{tc}{l}$ um zu der dimensionslosen Gleichung:
...
Diese Verteilung der Frequenzen für die Töne konnte durch einen möglichen Fehler beim bestimmen der Frequenzen entstanden sein, bei dem die fehlenden Vielfache des Grundtons verschwunden sind. Wir haben keinen physikalischen Grund gefunden der diese Verteilung erklärt, die Dämpfung die ein Störfaktor sein könnte beeinflusst zwar die einzelnen Schwingdauern der im Bezug auf den Fall ohne Dämpfung, jedoch sollten die Frequenzen da zueinander dadurch nicht stark beeinflust werden. Zumindest sollte kein quadratischer zusammenhang entstehen. 

\begin{equation} \label{oberton}
  f_n = \frac{1}{2l} \sqrt{\frac{F}{\roh}}n.
\end{equation}
...
An der korregierten Frequenz für die sich bildenen Schwingungen ist zu sehen, das zwar mit zunehmender Frequenz auch der abstand zwichen den Frequenzen steigen muss, da die Dämpfung zunehmend kleineren einfluss auf die Freqeunz hat. 
...
Die dadurch erhaltene nummerische Lösung konnten wir darufhin nach den Einschingen über die FFT in die zugehörigen Frequenzen des Grundtons und der ersten 5 Obertöne zerlegen. Die dabei bestimmten Frequenz sind mit 5 Hz für den Grundton und 175 Hz für den 5ten Oberton recht klein, was ein skalierungs Fehler erahnen lässt, jedoch konnten wir diesen nicht finden. Es ist auch auffallend, dass die Frequenzen vom Grundton an in Näherung quadratische Zunehmen, dies kann durch eine konstante Dämpfung nicht erklärt werden. Somit müsste es an der gewählent nicht linearen Dämpfung des DGLs liegen und oder an einem möglichen Feheler beim Lösungsverfahren des Problems.
